...
public class TransactionProcess extends SourceProcess {
    ...
    public ServiceMessage process(String id_cuenta, String start, String end){
        ...
        try{
            ...
            log.error("TransactionProcess - Hubo un error en consulta a la base , en la línea {} en el método {}, detalle del error {}", e.getStackTrace()[0].getLineNumber(), e.getStackTrace()[0].getMethodName(), e);
